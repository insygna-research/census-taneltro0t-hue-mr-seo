...
Примеры:
  venv/bin/python carpathy/register.py mysite f8aa91f \
      --urls /moscow /volgograd \
      --targets "студия звукозаписи столица" "студия звукозаписи город" \
      --expected "⭐-сниппет за 14-21 день"

  venv/bin/python carpathy/register.py demo2 HEAD --urls / --targets "пример запроса"
